                    ...
                    <div className="bg-card w-full max-w-2xl border border-border rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden relative">
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-8">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 p-3 bg-muted/20 border border-border rounded-xl w-max">
                                    <div className="w-10 h-10 bg-muted flex items-center justify-center rounded-lg">
                                        <AlertCircle className="w-5 h-5 opacity-50" />
                                    </div>
                                    <div>
                                        <p className="text-sm font-semibold">screenshot.png</p>
                                        <p className="text-xs text-muted-foreground">Frontend visual placeholder</p>
                                    </div>
                                </div>
                            </div>
                        </div>
